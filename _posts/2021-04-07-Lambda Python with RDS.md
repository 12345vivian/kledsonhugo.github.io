---
layout: post
title: AWS Lambda Python com AWS RDS
subtitle: CRUD Python com RDS em minutos
gh-repo: kledsonhugo/kledsonhugo.github.io
gh-badge: [star, fork, follow]
tags: [AWS, Lambda, Python, RDS, IAM, Workbench]
comments: true
---
...
2. Copie o conteúdo dos arquivos Python [rds.py](https://github.com/kledsonhugo/aws-lambda-python-with-rds/blob/main/rds.py) e [rds_config.py](https://github.com/kledsonhugo/aws-lambda-python-with-rds/blob/main/rds_config.py) do GitHub e salve-os no diretório `rds`.
